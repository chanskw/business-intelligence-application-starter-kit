...
[![Deploy to Bluemix](https://bluemix.net/deploy/button.png)](https://bluemix.net/deploy?repository=git@github.com:watson-developer-cloud/business-intelligence-application-starter-kit.git)
